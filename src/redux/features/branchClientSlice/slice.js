...
export const branchSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder.addCase(GET_REQUEST.pending, (state) => {
      ...
      fulfilledStateReducer(state, action, 'branch_client', 'GET')
      ...
      fulfilledStateReducer(state, action, 'branch_client', 'POST')
      ...
      state.error = action.payload
       ...
       fulfilledStateReducer(state, action, 'branch_client', 'DELETE', 'b_client_id')
    }).addCase(DELETE_REQUEST.rejected, (state, action) => {
      state.loading = false
      state.error = action.payload
    }).addCase(UPDATE_REQUEST.fulfilled, (state, action) => {
      fulfilledStateReducer(state, action, 'branch_client', 'UPDATE', 'b_client_id')
