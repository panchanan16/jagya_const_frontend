        ...
        <SecondSlideLayout>
            <main>
                <div className="main-btn flex">
                    <Link to={`/projects`}>
                        <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 24 24"
                            id="arrow-left" className="main-svg">
                            <path fill=""
                                d="M17,11H9.41l3.3-3.29a1,1,0,1,0-1.42-1.42l-5,5a1,1,0,0,0-.21.33,1,1,0,0,0,0,.76,1,1,0,0,0,.21.33l5,5a1,1,0,0,0,1.42,0,1,1,0,0,0,0-1.42L9.41,13H17a1,1,0,0,0,0-2Z">
                            </path>
                        </svg>
                    </Link>
                    <button className="btn-primary" type="button" onclick="editProject(this)">
                ...
                <div className="p-employees flex align-center gap-10">
                    ...
                    <div className="employee-container flex align-center gap-10">
                        <div className="e-profile flex align-center" onclick="seeEmployee()">
                            <img src="/img/admin.jpg" alt="profile" loading="lazy" />
                            <p className="text">Mohibul Hoque</p>
                        </div>
                    </div>
                ...
                <div className="file-structure">
                    ...
                    <div className="files flex align-center gap-10 f-wrap">
                        <div className="file-data flex align-center gap-5">
                ...
                <div className="task">
                    <div className="task-header flex align-start j-between">
                        <h3>Tasks</h3>
                        <button className="btn-primary" type="button" onclick="addSubTask()">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="plus-circle"
                                className="">
                                <path fill=""
                                    d="M12,2A10,10,0,1,0,22,12,10,10,0,0,0,12,2Zm0,18a8,8,0,1,1,8-8A8,8,0,0,1,12,20Zm4-9H13V8a1,1,0,0,0-2,0v3H8a1,1,0,0,0,0,2h3v3a1,1,0,0,0,2,0V13h3a1,1,0,0,0,0-2Z">
                    ...
                    <div className="task-grid grid gtc-3 gap-10">
                            ...
                            <div className="task-box">
                                <p className="text">
                                    ...
                                    <span className="task-svg">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                            onclick="confirmAlert()" className="svg-18">
                                            <path fill=""
                                                d="M10,18a1,1,0,0,0,1-1V11a1,1,0,0,0-2,0v6A1,1,0,0,0,10,18ZM20,6H16V5a3,3,0,0,0-3-3H11A3,3,0,0,0,8,5V6H4A1,1,0,0,0,4,8H5V19a3,3,0,0,0,3,3h8a3,3,0,0,0,3-3V8h1a1,1,0,0,0,0-2ZM10,5a1,1,0,0,1,1-1h2a1,1,0,0,1,1,1V6H10Zm7,14a1,1,0,0,1-1,1H8a1,1,0,0,1-1-1V8H17Zm-3-1a1,1,0,0,0,1-1V11a1,1,0,0,0-2,0v6A1,1,0,0,0,14,18Z">
                                            </path>
                                        </svg>
                        ...
                        <div className="grid-box">
                            <p className="title inProgress flex align-center gap-10">
                                <span className="dot"></span>
                                Phase II
                            </p>
                        ...
                        <div className="grid-box">
                            <p className="title completed flex align-center gap-10">
                                <span className="dot"></span>
                                Phase III
                            </p>
                            <div className="task-box"></div>
