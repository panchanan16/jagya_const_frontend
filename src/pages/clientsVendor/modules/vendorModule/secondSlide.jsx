    ...
    return (
        <main>
            <div class="main-btn flex">
                ...
                <button class="btn-primary flex" type="button" onclick="editVendorsSuppliers()">
            ...
            <div class="contents grid gtc-2 gap-10">
                ...
                <div class="description flex">
                    <h3>Email ID:</h3>
                    <p class="text">sharmaMintu@gmail.com</p>
                </div>
                <div class="description flex">
                    <h3>Address:</h3>
            ...
            <hr />
                ...
                <div class="tabs">
                    <div class="tabs-list flex align-center gap-10">
                        <h3 class="active">Purchases</h3>
                        <h3>Payments</h3>
                    </div>
                    <div class="tabs-content">
                        {/* <!-- COLLECTIONS LIST --> */}
                        <div class="v-purchases">
                            <div class="v-purchases-heading flex align-start j-between">
                                <h2>Purchases</h2>
                                <div class="action-btn flex">
                                    <button class="btn-primary" type="button" onclick="addVendorPurchase()">
                                        ...
                                        <span class="text">Add a Purchase</span>
                                    </button>
                                </div>
                            </div>
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="view-all"
                        ...
                        {/* <!-- cLIENT EXPENSES  --> */}
                        <div class="v-payments hide">
                            <div class="v-payments-heading flex align-start j-between">
                                <h2>Payments</h2>
                                <div class="action-btn flex">
                            ...
                            <div class="vendor-payments-table">
                                <table>
                                    <thead>
                                        <tr>
                                            <th><input type="checkbox" name="checkbox" class="select-all" /></th>
