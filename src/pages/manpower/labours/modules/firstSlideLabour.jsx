    ...
    return (
        <FirstSlideLayout>
            <main>
                <div class="heading">
                    <h1>Labour List</h1>
                    <p class="title">Find the list of labours here</p>
                </div>

                <div class="top-section flex align-center j-between">

                    <div class="section-text">
                        <h2 class="flex gap-10">All Labours</h2>
                    </div>
                    <div class="utility-section flex align-center gap-10">
                        ...
                        <div class="add-button">
                            <button class="btn-primary" type="button" onclick="addLabour()">
                                ...
                                <span class="text">Add a Labour</span>
                            </button>
                        </div>
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th class="">No.</th>
                            <th class="">Date</th>
                            <th class="">Labour Name</th>
                            <th class="">Project Name</th>
                            <th class="">Labour Verification</th>
                            <th class="">Verification Document</th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>1</td>
                            <td>12-Nov-2024</td>
                            <td class="text">Mriganka Nath</td>
                            <td class="text">RCC</td>
                            <td class="text">
                                <button class="status success">Verified</button>
                            </td>
                            <td>
                                <button class="view" onclick="viewVerification()">View Photo</button>
                            </td>
                        </tr>
                    </tbody>
                    <tfoot>
