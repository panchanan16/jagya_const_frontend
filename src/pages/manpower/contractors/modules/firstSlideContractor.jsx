    ...
    <FirstSlideLayout>
      <main>
        <div className="heading">
          ...
          <p className="title">Find the list of contractors here</p>
        </div>

        <div className="top-section flex align-center j-between">
          <div className="section-text">
            <h2 className="flex gap-10">All Contractors</h2>
          </div>
            ...
            <div className="add-button">
              <Link to="add-contractor">
                <button className="btn-primary" type="button">
                  ...
                  <span className="text">Add a Contractor</span>
                </button>
              </Link>
            </div>
          </div>
          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td className="">
                  <ItemActionBox viewFn={`/contractor/4`} />
                </td>
              </tr>
            </tbody>
            <tfoot>
