        ...
        <PopupLayout>
            <div className="inventory-popup">
                <div className="flex align-start j-between">
                    <h2>Request No: 1</h2>
                    <button type="button" className="btn-warning close" onClick={closePopupLayout}>Close</button>
                </div>
                ...
                <div className="approveAll-btn flex align-center gap-10">
