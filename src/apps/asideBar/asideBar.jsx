    ...
    <nav>
        ...
        <ul class="nav-list">
            ...
            <li>
                ...
                <div class="sub-menu">
                    <p onclick="location.href=`/finances`">Finances</p>
                    <p onclick="location.href=`/expenses`">Expenses</p>
                    {/* <!-- <p onclick="location.href=`/payments`">Payments</p> --> */}
                    <p onclick="location.href=`/invoices`">Invoices</p>
                </div>
            </li>
            <li>
                <a class="flex align-center gap-5">
