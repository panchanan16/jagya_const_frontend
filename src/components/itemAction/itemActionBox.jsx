...
function ItemActionBox({ viewFn }) {
    ...
    return (
        <div class="menu-dropdown">
            <div class="dropdown-icon" onClick={toggleModel}>
            ...
            <div class={`menu-dropdown-list flex align-center flex-column ${showModel ? '' : 'hide'}`}>
                {viewFn && <p class="title flex align-center gap-5"
                    onClick={viewFn}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                        id="eye" class="svg-18">
                        <path
