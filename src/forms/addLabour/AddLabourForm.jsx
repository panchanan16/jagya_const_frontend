      ...
      <Form>
        <div className={`${styles.formGrid} ${styles.formGridTwoColumns}`}>
          <div className={styles.fieldGroup}>
            <label className={`${styles.fieldLabel} ${styles.required}`}>Labour Name</label>
            <Field 
              type="text" 
              name="lab_name" 
          ...
          <div className={styles.fieldGroup}>
            <label className={`${styles.fieldLabel} ${styles.required}`}>Number</label>
            <Field 
              type="number" 
              name="lab_contact" 
              className={styles.formInput}
...
function AddLabourForm() {
  ...
  return (
    <PopupLayout>
      <div className={`${styles.formContainer} add-clients-prospects blur`}>
        <div className={`${styles.formHeader}`}>
          <h2 className={styles.formTitle}>Add a Labour</h2>
          <Link to={`/admin/labour`}>
